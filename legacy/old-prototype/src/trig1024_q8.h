#ifndef MEGALDOOM_TRIG1024_Q8_H
#define MEGALDOOM_TRIG1024_Q8_H

#include <genesis.h>

// 1024-step full-circle sine table, Q8 fixed point.
// sin = SIN1024_Q8[angle & 1023], cos = SIN1024_Q8[(angle + 256) & 1023].
static const s16 SIN1024_Q8[1024] = {
