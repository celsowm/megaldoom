...
// Tiled rock backdrop around the 3D viewport (renderer_draw_backdrop in
// renderer_hud.c; tiles generated by tools/generate-backdrop-tiles.py).
#define BACKDROP_TILE_BASE (WEAPON_TILE_BASE + MEGALDOOM_WEAPON_TILE_COUNT)
...
#if STATIC_CEILING_ATLAS_BASE < (BACKDROP_TILE_BASE + MEGALDOOM_BACKDROP_TILE_COUNT)
#error "Static ceiling/floor atlas collides with the backdrop tile region"
#endif
