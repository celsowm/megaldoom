...
- Projected wall height is `height = 10240 / depth`, clamped to `RAY_VIEW_ROWS`
  (120) in `src/bsp/bsp_render.c` (~line 444-448). So the vertical sampling ratio
  never gets worse than 120 rows / 64 texels = 1.875, no matter how close the
  player stands.
...
- vertical sampling tables — generated by `tools/generate-renderer-assets.ps1`
  (`MEGALDOOM_WALL_TEX_Y_BY_HEIGHT[121][120]`; stays `u8`, since 0..127 still
  fits, so this table does not grow);
