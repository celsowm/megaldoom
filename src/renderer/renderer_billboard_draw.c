...
static const u8 *const IMP_FRAME_PIXELS[FREEDOOM_BILLBOARD_IMP_FRAME_COUNT] = {
    (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[0], (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[1],
    (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[2], (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[3],
    (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[4], (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[5],
    (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[6], (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[7],
    (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[8], (const u8 *)FREEDOOM_BILLBOARD_IMP_FRAMES[9],
};
static const u8 *const DEMON_FRAME_PIXELS[FREEDOOM_BILLBOARD_DEMON_FRAME_COUNT] = {
    (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[0], (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[1],
    (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[2], (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[3],
    (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[4], (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[5],
    (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[6], (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[7],
    (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[8], (const u8 *)FREEDOOM_BILLBOARD_DEMON_FRAMES[9],
};
...
static BillboardTex get_billboard_texture(u8 visual_id, u8 frame) {
    switch (visual_id) {
        ...
        case BILLBOARD_VISUAL_IMP: {
            const u8 f = (frame < FREEDOOM_BILLBOARD_IMP_FRAME_COUNT) ? frame : 0;
            return (BillboardTex){IMP_FRAME_PIXELS[f],
                                  FREEDOOM_BILLBOARD_IMP_W, FREEDOOM_BILLBOARD_IMP_H};
        }
        case BILLBOARD_VISUAL_DEMON: {
            const u8 f = (frame < FREEDOOM_BILLBOARD_DEMON_FRAME_COUNT) ? frame : 0;
            return (BillboardTex){DEMON_FRAME_PIXELS[f],
                                  FREEDOOM_BILLBOARD_DEMON_W, FREEDOOM_BILLBOARD_DEMON_H};
        }
