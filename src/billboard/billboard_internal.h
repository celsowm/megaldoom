...
const u16 *billboard_registry_active_indices(void);
const u16 *billboard_registry_enemy_indices(void);
const u16 *billboard_registry_target_indices(void);
const u16 *billboard_registry_blocking_indices(void);
